...
- Extracted content does not include images, diagrams, embedded charts, SmartArt
- Screenshots, comments, and revision history are not extracted
- Complex formatting may be lost in Markdown conversion
- Macros in .xlsm files are not extracted
...
- Creating traceable references from source documents
- Preparing documents for RAG systems

## Tips

- Always extract to a dedicated output directory for traceability
- Use the extraction as a reference, verify against source when needed
