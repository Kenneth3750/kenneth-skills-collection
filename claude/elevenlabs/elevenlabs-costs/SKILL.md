...
python ${SKILL_DIR}/scripts/calculate-costs.py 30 --detail    # With per-conversation detail
python ${SKILL_DIR}/scripts/calculate-costs.py 7 --agent agent_XXX  # Single agent only
```
