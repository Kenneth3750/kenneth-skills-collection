...
For example:
- `agents/web-engineer/todo/001-create-audio-capture.md`
- `agents/app-engineer/todo/001-setup-project.md`
...
> **IMPORTANT**: Follow these rules to the letter.
...
- If there's pending related work
```
